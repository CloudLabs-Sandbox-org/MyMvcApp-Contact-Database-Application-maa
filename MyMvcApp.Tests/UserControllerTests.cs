...
public class UserControllerTests
{
    ...
    public void Index_ReturnsFilteredUsers_WhenSearchStringIsProvided()
    {
        ...
        // Act
        var result = _controller.Index("Alice");
        ...
        Assert.DoesNotContain(user2, model);
    }

    [Fact]
    public void Index_ReturnsAllUsers_WhenSearchStringIsEmpty()
    {
        // Arrange
        var user1 = new User { Id = 1, Name = "Alice", Email = "alice@example.com" };
        var user2 = new User { Id = 2, Name = "Bob", Email = "bob@example.com" };
    ...
    [Fact]
    public void Index_ReturnsNoUsers_WhenSearchStringDoesNotMatch()
    {
        // Arrange
        var user1 = new User { Id = 1, Name = "Alice", Email = "alice@example.com" };
        var user2 = new User { Id = 2, Name = "Bob", Email = "bob@example.com" };
        ...
        // Act
        var result = _controller.Index("Charlie");
